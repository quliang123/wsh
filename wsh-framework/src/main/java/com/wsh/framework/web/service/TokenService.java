...
import com.wsh.common.utils.uuid.IdUtils;
...
public class TokenService
{
    ...
    public String createWxToken(WxLoginUser loginUser, String sessionKey) {
        loginUser.setSessionKey(sessionKey);
        refreshToken(loginUser);
//        Map<String, Object> claims = new HashMap<>();
//        claims.put(Constants.LOGIN_USER_KEY, sessionKey);
        return sessionKey;
    }
    ...
    {
        loginUser.setLoginTime(System.currentTimeMillis());
        loginUser.setExpireTime(loginUser.getLoginTime() + wxExpireTime * MILLIS_MINUTE);
        // 根据uuid将loginUser缓存
        String userKey = getTokenKey(loginUser.getSessionKey());
        redisCache.setCacheObject(userKey, loginUser, wxExpireTime, TimeUnit.MINUTES);
    }
